...
const Chat = () => {
  return (
    <div>
      ...
      <div className="flex h-screen antialiased text-gray-800 fixed pt-10">
  <div className="flex flex-row h-full w-full overflow-x-hidden">
    ...
    <div className="flex flex-col flex-auto h-fit p-6 pb-20">
        <div className='p-1 '> 
        <button className="flex flex-row bg-gray-200 items-center w-full hover:bg-gray-100 rounded-xl p-2">
            <div className="flex items-center justify-center h-8 w-8 bg-indigo-200 rounded-full">H</div>
            <div className="ml-2 text-sm font-semibold">Henry Boyd</div>
          </button>
          </div>
