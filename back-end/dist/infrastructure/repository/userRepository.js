...
var userRepository = /** @class */ (function () {
    ...
    userRepository.prototype.getUser = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    userRepository.prototype.checkOtp = function (email, otp) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, userModel_1.default.findOneAndUpdate({ email: email }, { verified: true })];
                    case 2:
                        _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!user) {
                            ...
                            return [2 /*return*/, 'user not verified'];
                        }
    ...
    userRepository.prototype.selectUser = function (userType, email, name) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, user.id];
                    case 2: return [4 /*yield*/, userModel_1.default.create({ name: name, email: email, userType: userType })];
                    case 3:
                        createdUser = _a.sent();
