...
var userBlock = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, parsedToken, decoded, userId, user, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!(userId == process.env.ADMIN)) return [3 /*break*/, 1];
                next();
                return [3 /*break*/, 3];
            case 1: return [4 /*yield*/, userModel_1.default.findById(userId)];
            case 2:
                user = _b.sent();
                if (user.active) {
                    next();
